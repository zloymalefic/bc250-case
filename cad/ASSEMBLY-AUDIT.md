...
| ESP32 service cover ↔ chassis | integrated, unvalidated | The solid 98 × 32 mm cover replaces a matching 3 mm shell seat and ends at the lower edge of the intake cover without overlap. It has no exterior ventilation slots or magnets and uses four hidden cantilever hooks. Envelope, rail support, cover/opening containment and cover-to-cover separation are asserted; physical snap fit remains open. |
